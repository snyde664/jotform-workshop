...
JF.initialize({ apiKey: "0f777bda22b4e72e14333eabd878f17e" }); //PUT YOUR OWN KEY HERE
 
// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223186262857059", function (response) {
...
mapboxgl.accessToken = "pk.eyJ1Ijoic255ZGU2NjQiLCJhIjoiY2w5d3YyZXI4MDE0ejNvcGxrb3Y4Ynh5NyJ9.lOWt_JZmaTPLrWAmFGYoAA"
    ...
    map.addLayer(
        new MapboxLayer({
            ...
            onClick: (info) => {
                ...
                getImageGallery(info.object.fileUpload, info.object.grantName);
